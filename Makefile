# This Makefile is for the cmail extension to perl.
#
...
#	ABSTRACT => q[a modular mail checker]
#	AUTHOR => q[Chip Marshall <chip@chocobo.cx>]
#	EXE_FILES => [q[cmail]]
#	NAME => q[cmail]
#	PMLIBDIRS => [q[CMail]]
#	VERSION_FROM => q[cmail]
#	dist => { COMPRESS=>q[bzip2 -fv], POSTOP=>q[pgps -b $(DISTVNAME).$(TAR)$(SUFFIX)], SUFFIX=>q[.bz2] }
...
PM_TO_BLIB = CMail/In/Base.pm \
	$(INST_LIBDIR)/CMail/In/Base.pm \
	CMail/Out/Base.pm \
	$(INST_LIBDIR)/CMail/Out/Base.pm \
	CMail/Out/color.pm \
	$(INST_LIBDIR)/CMail/Out/color.pm \
	CMail/In/file.pm \
	$(INST_LIBDIR)/CMail/In/file.pm \
	CMail/In/maildir.pm \
	$(INST_LIBDIR)/CMail/In/maildir.pm \
	CMail/In/pop3.pm \
	$(INST_LIBDIR)/CMail/In/pop3.pm \
	CMail/Out/plain.pm \
	$(INST_LIBDIR)/CMail/Out/plain.pm \
	CMail/In/mbox.pm \
	$(INST_LIBDIR)/CMail/In/mbox.pm \
	CMail/In/imap.pm \
	$(INST_LIBDIR)/CMail/In/imap.pm
...
SHAR = shar
PREOP = @$(NOOP)
POSTOP = pgps -b $(DISTVNAME).$(TAR)$(SUFFIX)
TO_UNIX = @$(NOOP)
CI = ci -u
...
$(INST_MAN1DIR)/.exists :: /usr/libdata/perl/5.00503/mach/CORE/perl.h
	@$(MKPATH) $(INST_MAN1DIR)
	@$(EQUALIZE_TIMESTAMP) /usr/libdata/perl/5.00503/mach/CORE/perl.h $(INST_MAN1DIR)/.exists
...
manifypods : pure_all cmail
	@$(POD2MAN) \
	cmail \
	$(INST_MAN1DIR)/cmail.$(MAN1EXT)
...
$(INST_SCRIPT)/.exists :: /usr/libdata/perl/5.00503/mach/CORE/perl.h
	@$(MKPATH) $(INST_SCRIPT)
	@$(EQUALIZE_TIMESTAMP) /usr/libdata/perl/5.00503/mach/CORE/perl.h $(INST_SCRIPT)/.exists
...
pure_all :: $(INST_SCRIPT)/cmail
	@$(NOOP)

realclean ::
	rm -f $(INST_SCRIPT)/cmail

$(INST_SCRIPT)/cmail: cmail Makefile $(INST_SCRIPT)/.exists
	@rm -f $(INST_SCRIPT)/cmail
	cp cmail $(INST_SCRIPT)/cmail
	$(FIXIN) $(INST_SCRIPT)/cmail
	-@$(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/cmail
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/CMail/In/Base.pm $(INST_LIBDIR)/CMail/Out/Base.pm $(INST_LIBDIR)/CMail/Out/color.pm $(INST_LIBDIR)/CMail/In/file.pm $(INST_LIBDIR)/CMail/In/maildir.pm $(INST_LIBDIR)/CMail/In/pop3.pm $(INST_LIBDIR)/CMail/Out/plain.pm $(INST_LIBDIR)/CMail/In/mbox.pm $(INST_LIBDIR)/CMail/In/imap.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"cmail\" VERSION=\"4,01,0,0\">\n}. qq{\t<TITLE>cmail</TITLE>\n}. qq{\t<ABSTRACT>a modular mail checker</ABSTRACT>\n}. qq{\t<AUTHOR>Chip Marshall &lt;chip\@chocobo.cx&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-freebsd\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > cmail.ppd
